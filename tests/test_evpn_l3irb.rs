...
use toy_tcpip::evpn_l3irb::{
    EvpnIpPrefixRoute, EvpnL3VrfTable, BGP_EXT_COMMUNITY_ROUTER_MAC, EVPN_ROUTE_TYPE_IP_PREFIX,
};
use toy_tcpip::ipv4::Ipv4Address;

#[test]
fn test_evpn_l3_irb_symmetric_routing_table() {
    let mut vrf = EvpnL3VrfTable::new("TENANT-BLUE", 50002, MacAddress([0x00, 0x11, 0x22, 0x33, 0x44, 0x01]));
