use toy_tcpip::diameter::{DiameterAvp, DiameterMessage, DiameterServer, DIAMETER_AVP_ORIGIN_HOST, DIAMETER_AVP_RESULT_CODE, DIAMETER_CMD_CAPABILITIES_EXCHANGE, DIAMETER_CMD_DEVICE_WATCHDOG, DIAMETER_FLAG_REQUEST, DIAMETER_PORT, DIAMETER_SUCCESS, DIAMETER_VERSION_1};
...
fn test_diameter_avp_and_cer_cea_flow() {
    ...
    assert_eq!(parsed_cea.header.flags & DIAMETER_FLAG_REQUEST == 0, true); // Answer
