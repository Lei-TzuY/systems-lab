use toy_tcpip::quic::{
    QUIC_PKT_HANDSHAKE, QUIC_PKT_INITIAL, QUIC_VERSION_1, QuicPacket, decode_vint, encode_vint,
};
...
fn test_quic_packet_initial_and_short_headers() {
    ...
    let initial =
        QuicPacket::build_initial(vec![0x01, 0x02, 0x03], vec![0x04, 0x05], b"Initial Token");
